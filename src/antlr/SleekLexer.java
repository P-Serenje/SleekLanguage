...
public class SleekLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FUNC", "IF", "ELSE", "WHILE", "PRINT", "INPUT", "INPUTFLOAT", "INPUTSTRING", 
			"RETURN", "ASSIGN", "EQ", "NEQ", "LE", "GE", "LT", "GT", "PLUS", "MINUS", 
			"MUL", "DIV", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMI", "COMMA", 
			"INT", "FLOAT", "STRING", "ID", "WS", "LINE_COMMENT", "COMMENT"
		};
	}
	...
	public SleekLexer(CharStream input) {
		super(input);
